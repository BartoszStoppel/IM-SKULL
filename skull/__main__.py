...
from skullpy.compiler import compile, ParseError
from skullpy.vm import Machine

EXIT_FAILURE = 1
EXIT_SUCCESS = 0

log = logging.getLogger("skullpy")
...
def main(file: click.File, debug: bool, input: int) -> int:
    """
    A Python implementation of the skull esoteric programming language.

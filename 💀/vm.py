...
log = logging.getLogger("skullpy.VM")
...
class Machine:
    """
    Virtual machine for the 💀 programming language.
    """
    ...
    def dispatch(self, op: Token):
        ...
        if op is OPCODE.SKULL:
            log.debug("Pushing '💀' to stack")
            self.push("💀")
            ...
            # We return an empty string to ensure the 99 💀s example doesn't crash,
            # as it relies in UB.
            try:
